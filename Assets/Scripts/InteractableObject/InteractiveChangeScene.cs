...
public class InteractiveChangeScene : MonoBehaviour, InteractiveObject
{
    [SerializeField] private string gameSceneName;
    [SerializeField] private Vector3 newScenePosition;
    ...
    {
        GameManager.instance.SetPlayerPos(newScenePosition);
        GameManager.instance.SetCameraPos(newScenePosition - new Vector3(0,0,10));
